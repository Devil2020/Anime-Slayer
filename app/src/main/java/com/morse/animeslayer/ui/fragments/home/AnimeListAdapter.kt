...
interface AnimeListListener {
    ...
    fun onAnimeLongClicked (animeImageView : ImageView , animeName : TextView , anime : AnimeListResponse.Anime)
}
...
class AnimeListAdapter (private val animeListListener: AnimeListListener) : RecyclerView.Adapter<AnimeListAdapter.AnimeViewHolder>() {
    ...
    private val listOfAnime = ArrayList<AnimeListResponse.Anime> ()

    fun submit (incomingAnimes : ArrayList<AnimeListResponse.Anime>) {
