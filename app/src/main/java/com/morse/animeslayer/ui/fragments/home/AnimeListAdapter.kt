...
interface AnimeListListener {
    fun onAnimeClicked ( animeView : View , anime : Anime)
    fun onAnimeLongClicked (animeImageView : ImageView , animeName : TextView , anime : Anime)
}

val ANIME_LIST = arrayListOf(
    Anime(
...
class AnimeListAdapter (private val animeListListener: AnimeListListener) : RecyclerView.Adapter<AnimeListAdapter.AnimeViewHolder>() {
    ...
    private val listOfAnime = ArrayList<Anime> ()

    fun submit (incomingAnimes : ArrayList<Anime>) {
        listOfAnime.addAll(incomingAnimes)
    ...
    inner class AnimeViewHolder(val binding: AnimeItemLayoutBinding) :
        ...
        fun bindAnimeDataToBinding(animeItem: Anime) {
            binding.animeItem = animeItem
            binding.root.setOnClickListener {
                animeListListener.onAnimeClicked(binding.root , animeItem)
            }
            binding.root.setOnLongClickListener {
                animeListListener.onAnimeLongClicked( binding.animeImage , binding.animeName,  animeItem)
                true
            }
        }
